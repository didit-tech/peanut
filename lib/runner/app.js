...
global.error = function(timeoutId, scenario, step, feature, callback) {
...
function welcomeMessage() {
  ...
  buf.push("");
  if (!envExists) buf.push(style.red("    INFO: Could not find " +
    "features/support/env.js.  You need to run your application manually."));
  sys.puts(buf.join("\n"));
};
